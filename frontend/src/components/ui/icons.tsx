// Small shared icon set (currentColor, 20x20 viewBox) used across the
// project detail components so we don't re-declare the same SVGs per file.
...
export function PencilIcon({ className = 'h-4 w-4' }: IconProps) {
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        d="M4 6a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H4V8h3a1 1 0 000-2H4z"
        clipRule="evenodd"
      />
    </svg>
  );
